<div class="mt-8">
    <a href="{{route('movies.show', $movie['id'])}}">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w500/{{$movie['poster_path']}}" alt="{{$movie['original_title']}}" class="hover:opacity-75 transition ease-in-out duration-150">
    </a>
    <div class="mt-2">
